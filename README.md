...
### Changes in 1.5-beta.1
Added conductivity calculation and parameters through the params['fsP'] function

### Changes in 1.4.2
Added more debugging and profiling features.

### Changes in 1.4.1
Removed extra function parameters that didn't do anything and fixed ionosphere example. Fixed SUPG stabilization.

### Changes in 1.4.0
Stabilized code, fixed ABEP example case.

### Changes in 1.4.0-rc.2
Major bugfixes for general processes and parallelization.
